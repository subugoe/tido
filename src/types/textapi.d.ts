declare global {
  ...
  /** Asset */
  interface Asset {
    /** @description one of font or css */
    assetType: TypeEnum
    /**
     * Contenttype
  ...
  interface Image {
     ...
     */
    mimetype: 'application/ld+jsonprofile="http://iiif.io/api/presentation/3/context.json' | string | null
  }
  /**
   * Integrity
  ...
  interface Repository {
    ...
    /**
     * Externalid
     * @description the identifier at the hosting institution
     */
  ...
  /**
   * Collection
   * @description A collection contains a curated list of texts.
   * @example {
   *       "collectors": [
   *         {
   *           "name": "Stefan",
   ...
   *         }
   *       ],
   *       "context": "https://gitlab.gwdg.de/subugoe/textapi/specs/-/raw/main/jsonld/v2.jsonld",
  ...
  interface Collection {
    ...
    /**
     * Funders
     * @description an entity responsible for funding the project in which the text(s) in focus is/are edited
     */
    funders?: Agent[] | null
    /**
     * Id
    ...
    /**
     * Titles
     * @description The title(s) of the collection. First item im array is the main title.
     */
    titles: string[]
    /**
     * Total
     * @description Total number of collection or manifests or collections included in this collection
     */
    total: number
    /**
     * Via
