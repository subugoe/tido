...
import AnnotationFooter from '@/components/panel/annotations/sidebar/AnnotationFooter.tsx'
...
const Annotation: FC<Props> = React.memo(({ data, top, onToggle, isNested = false }) => {
  ...
  useEffect(() => {
    ...
    const nonCrossRefChildren = children.filter((a) => a.body?.annotationType !== 'CrossRef')
