...
const Panel: FC = () => {
  ...
  return (
    <div className="panel t-flex t-flex-col t-w-[300px] t-h-[800px] t-mr-6 t-border-solid t-border-2 t-border-slate-200 t-rounded-lg t-mt-4 t-px-2.5 t-pt-8 t-pb-6">
      <PanelTopBar />
