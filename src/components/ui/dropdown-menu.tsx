...
const DropdownMenuPortal = ({
  ...
  return (
    <DropdownMenuPrimitive.Portal container={document.querySelector('.tido')} data-slot="dropdown-menu-portal" {...props} />
  )
}
    ...
    <DropdownMenuPrimitive.Portal container={document.querySelector('.tido')}>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          'origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-lg ' +
          'border border-border p-1 shadow-md',
          className
        )}
        {...props}
      />
...
const DropdownMenuLabel = ({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        'px-2 py-0.5 text-sm font-medium data-[inset]:pl-8',
        className
      )}
      {...props}
    />
