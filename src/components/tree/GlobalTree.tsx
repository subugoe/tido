...
const GlobalTree: FC = () => {
  ...
  return showGlobalTree && <div className="t-ml-10 t-w-92 t-mb-12 t-mt-4 t-mr-4 t-pt-4 t-border-r-2 t-border-gray-200">
    <div className="t-max-h-full t-overflow-hidden t-overflow-y-auto">
