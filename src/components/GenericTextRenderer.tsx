...
import {
  ...
  addHoverStyle,
  addNestedTargetStyle, addSelectedStyle, assignNestedTargetsInFlippedMatched,
  ...
  getTextTargets,
  isParentHovered,
  isTargetPartOfSelectedAnnotation, removeAnnotationBaseStyle, removeAnnotationIds,
  removeHighlightStyle,
  removeHoverStyle,
  removeNestedTargetStyle, removeSelectedStyle
} from '@/utils/text.ts'
...
const GenericTextRenderer: FC<Props> = memo(({
  ...
  useEffect(() => {
    ...
    flippedMatchedAnnotationsMapRef.current = flipMatchedAnnotationsMap(matchedMap)
  ...
  useEffect(() => {
    ...
    if (!flippedMatchedAnnotationsMapRef.current) return
