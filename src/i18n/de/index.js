export default {
  ...
  error_collection_url: 'Geben Sie bitte dir richtige URL für das collection in Config ein',
  error_manifest_url: 'Geben Sie bitte dir richtige URL für das manifest in Config ein',
  error_item_url: 'Geben Sie bitte dir richtige URL für das item in Config ein',
  error_no_manifests_in_initcollection: 'Das collection soll darin manifests enthalten',
  error_no_items_in_manifest: 'Das manifest soll mindestens einen Item enthalten',
  error_m_in_url_no_collection: 'Es gibt kein collection, daher bitte geben kein \'m\' im URL ein',
  error_item_not_in_manifest: 'Item ist nicht in dem initialisierten Manifest in config enthalten',
  error_manifestpart_tido_url: 'Bitte geben Sie das Manifest Teil im URL in der richtigen Form ein',
  error_itempart_tido_url: 'Bitte geben Sie das Item Teil im URL in der richtigen Form ein',
  error_panelspart_tido_url: 'Bitte geben Sie das Panels Teil im URL in der richtigen Form ein',
  error_showpart_tido_url: 'Bitte geben Sie das Show (s) Teil im URL in der richtigen Form ein',
