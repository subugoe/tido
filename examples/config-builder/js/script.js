...
document.addEventListener("DOMContentLoaded", function () {
  const config = [
    ...
    },
    {
      ...
      fields: [
        { name: "show", type: "switch", label: "Show", default: true, description: 'Toggle visibility of the whole header' },
        { name: "navigation", type: "switch", label: "navigation", default: true, description: 'Toggle visibility of prev/next buttons' },
        { name: "panelsToggle", type: "switch", label: "panelsToggle", default: true, description: 'Toggle visibility of panel toggle buttons' },
        { name: "languageSwitch", type: "switch", label: "languageSwitch", default: false, description: 'Toggle visibility of language switch for supported languages' },
      ]
    },
    {
      name: "lang",
                    ...
                    "5": [
                      {
                        ...
                        fields: [
                          ...
                          { name: "icon", type: "icons", label: "Icon" }
                        ]
                      }
                    ]
                  }
