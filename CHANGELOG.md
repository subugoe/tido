...
- Update npm packages to it's actual version
- remove entrypoint pointing to the Ahikar collection to prepare the release
- add token to npmrc to prepare auth in regards to publishing
