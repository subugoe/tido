...
| types[i].icon           | String                 | `null`       | Specifies an icon that is displayed on the left of the annotation item. Currently we provide only a fixed list of possible icons [here](#icons). If left out, no icon will be displayed.              |
