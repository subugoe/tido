...
const selectors = {
  ...
  describe('VariantsAnnotation', () => {
    ...
    describe('Highlighted Text selection', () => {
      ...
      it('should show correct witnesses chips in text Panel and number of selected variant Items when first deselecting a few witnesses and then clicking the target', () => {
        cy.get(selectors.list)
          .clickWitnessItem('4 Witnesses selected', 'Cod. Arab. 236')
          .parent().parent()
